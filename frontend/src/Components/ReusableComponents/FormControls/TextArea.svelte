<script lang="ts">
    ...
    export let validator: (arg:any) => void  = (arg:any) => {};
</script>
...
<section class={`form-group d-flex flex-column align-items-start ${col}}`}>
    ...
    <textarea on:change={(e) => validator(e.target.value)} bind:value={textValue} id={CONTROL_ID} class="form-control" placeholder={placeholderValue}></textarea>
